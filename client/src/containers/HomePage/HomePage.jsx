  ...
  return (
    <main className='w-full p-5 flex flex-col gap-5 items-center max-w-screen-2xl mx-auto'>
      ...
      <section className='pb-10 flex flex-col'>
        ...
        <button className='w-full m-auto md:w-1/4 rounded-lg border-red border px-8 py-2 text-red font-bold mx-auto mt-10 hover:bg-red hover:text-white transaction-all easy-in-out duration-500 ' onClick={updateItems} disabled={false} >
          Load more
        </button>
      </section>
      {/* <Popup /> */}
